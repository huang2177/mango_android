 ...
 * k线图
 */
public abstract class TradeBaseKChart extends ScrollAndScaleView
    ...
    //k线图距离顶部的距离
    protected int mMainTopSpace = 0;
    //k线图和子图像之间的空隙
    protected int mMainChildSpace = 0;
    //k线图和时间之间的空隙
    ...
    //子图当前显示区域的最大值
    protected float mChildMaxValue = 0;
    //子图当前实现区域的最小值
    protected float mChildMinValue = 0;
    //显示区域中X开始点在数组的位置
    ...
    public TradeBaseKChart(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TradeBaseKChart(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setColorStyle(Context context){
        ...
        this.gridLineColor = ContextCompat.getColor(context, R.color.color_f0f0f0);
        this.lineColor = ContextCompat.getColor(context, R.color.color_f0f0f0);
        this.textColor = ContextCompat.getColor(context, R.color.color_323232);
    }

    private void init(boolean yeStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        this.mMainHeight =displayHeight;
        this.mWidth = w;
...
//        LogUtil.e("MaxValue:" + mMainMaxValue
//                + " MinValue:" + mMainMinValue
//                + " C:" + (mMainMaxValue - mMainMinValue)
//                + " RowsY:" + rowsY
//                + " Top:" + mMainTopSpace
//                + " Y:" + y
//                + " H:" + mMainHeight);
    ...
    protected void drawSelector(IKChartView view, Canvas canvas) {
        mTextPaint.setColor(getResources().getColor(R.color.color_323232));
...
//        }
        ...
        for (int i = 0 ; i< strings.size() ; i ++){
            if (i == 0){
                ...
                mTextPaint.setColor(point.getCloseVal() > point.getOpenVal() ? color_F74F54 : (point.getCloseVal() < point.getOpenVal() ? color_1AC47A : color_333333));
                ...
                mTextPaint.setColor(mPriceNum > 0 ? color_F74F54 : (mPriceNum < 0 ? color_1AC47A : color_333333));
