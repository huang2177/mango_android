package com.paizhong.manggo.utils.bar;
...
public class StatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            View decorView = activity.getWindow().getDecorView();
            int option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                    | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
    ...
    public static void setBarView(Context context,View view){
    ...
    public static void setTitleBarHeight(View view, int height) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
