 ...
 */
public class CommonNoViewTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonNoViewTabLayout(Context context) {
        this(context, null, 0);
    }

    public CommonNoViewTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonNoViewTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextPaddingLeft = ta.getDimension(R.styleable.CommonTabLayout_tl_textPaddingLeft, 0);
        mTextPaddingRight = ta.getDimension(R.styleable.CommonTabLayout_tl_textPaddingRight, 0);
    ...
    public void notifyDataSetChanged() {
        ...
        if (mListener != null) {
            mListener.onTabSelect(mCurrentTab, CommonNoViewTabLayout.this);
        }
    }
    ...
    private void addTab(final int position, View tabView) {
        ...
        tv_tab_title.setPadding((int)mTextPaddingLeft,0,(int)mTextPaddingRight,0);
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    if (mListener != null) {
                        mListener.onTabSelect(position, CommonNoViewTabLayout.this);
                    }
                } else {
                    if (mListener != null) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravityBlue){
                    mIndicatorDrawable.setColor(Color.parseColor("#FF5500"));
                }else {
