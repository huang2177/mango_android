...
public class WebViewActivity extends SobotBaseActivity implements View.OnClickListener {
    ...
    private View sobot_layout_titlebar;
    ...
    protected void initView() {
        ...
        sobot_layout_titlebar = findViewById(getResId("sobot_layout_titlebar"));
        sobot_layout_titlebar.setVisibility(View.GONE);
    ...
    private void initWebView() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Uri webUri = TextUtils.isEmpty(url) ? null : Uri.parse(url);

                if (webUri != null && TextUtils.equals("main", webUri.getLastPathSegment())) {
                    try {
                        Intent intent = new Intent(WebViewActivity.this,Class.forName("com.paizhong.manggo.ui.main.MainActivity"));
                        intent.putExtra("page", getInt(webUri.getQueryParameter("page"), -1));
                        intent.putExtra("smPage", getInt(webUri.getQueryParameter("smPage"), 0));
    ...
    private  int getInt(String num1, int placeholder) {
