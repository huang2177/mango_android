...
public class UpdateManager {
    ...
    public static class Builder {
        ...
        public Builder setUserInfo(@NonNull UpdateInfo info) {
            mInfo = info;
            return this;
        }
        ...
        public Builder setEndListener(@NonNull OnEndListener listener) {
